...
class evententry_save_comment extends SectionEvent
{
    public $ROOTELEMENT = 'entry-save-comment';
...
...&lt;/entry-save-comment></code></pre>
    ...
    &lt;label>For Post
        &lt;select name="fields[for-post]">
            ...
            &lt;option value="My five favorite forgotten foods">My five favorite forgotten foods&lt;/option>
            &lt;option value="PP: Chuck\'s Restaurant">PP: Chuck\'s Restaurant&lt;/option>
            ...
            &lt;option value="The Perfect Burger">The Perfect Burger&lt;/option>
        &lt;/select>
    &lt;/label>
    &lt;label>Date Modified
...
&lt;/form></code></pre>
    ...
    {
        if (isset($_POST['action']['entry-save-comment'])) {
