...
INSERT INTO`tbl_fields_checkbox` (`id`, `field_id`, `default_state`) VALUES (15, 16, 'off');
...
INSERT INTO`tbl_fields_date` (`id`, `field_id`, `pre_populate`) VALUES (18, 4, 'yes');
...
INSERT INTO`tbl_fields_datemodified` (`id`, `field_id`, `pre_populate`, `editable`, `mode`) VALUES (6, 14, 'no', 'no', 'hidden');
...
INSERT INTO`tbl_fields_input` (`id`, `field_id`, `validator`) VALUES (80, 1, NULL);
INSERT INTO`tbl_fields_input` (`id`, `field_id`, `validator`) VALUES (79, 7, NULL);
INSERT INTO`tbl_fields_input` (`id`, `field_id`, `validator`) VALUES (70, 10, NULL);
INSERT INTO`tbl_fields_input` (`id`, `field_id`, `validator`) VALUES (71, 11, '/^\\w(?:\\.?[\\w%+-]+)*@\\w(?:[\\w-]*\\.)+?[a-z]{2,}$/i');
INSERT INTO`tbl_fields_input` (`id`, `field_id`, `validator`) VALUES (72, 15, '/^[^\\s:\\/?#]+:(?:\\/{2,3})?[^\\s.\\/?#]+(?:\\.[^\\s.\\/?#]+)*(?:\\/[^\\s?#]*\\??[^\\s?#]*(#[^\\s#]*)?)?$/');
INSERT INTO`tbl_fields_input` (`id`, `field_id`, `validator`) VALUES (73, 17, NULL);
INSERT INTO`tbl_fields_input` (`id`, `field_id`, `validator`) VALUES (74, 21, NULL);
INSERT INTO`tbl_fields_input` (`id`, `field_id`, `validator`) VALUES (75, 22, NULL);
INSERT INTO`tbl_fields_input` (`id`, `field_id`, `validator`) VALUES (76, 23, NULL);
INSERT INTO`tbl_fields_input` (`id`, `field_id`, `validator`) VALUES (77, 30, NULL);
INSERT INTO`tbl_fields_input` (`id`, `field_id`, `validator`) VALUES (78, 31, NULL);
...
INSERT INTO`tbl_fields_select` (`id`, `field_id`, `allow_multiple_selection`, `show_association`, `static_options`, `dynamic_options`, `sort_options`) VALUES (47, 5, 'no', 'no', 'draft, published', NULL, 'no');
INSERT INTO`tbl_fields_select` (`id`, `field_id`, `allow_multiple_selection`, `show_association`, `static_options`, `dynamic_options`, `sort_options`) VALUES (42, 13, 'no', 'no', NULL, 1, 'no');
INSERT INTO`tbl_fields_select` (`id`, `field_id`, `allow_multiple_selection`, `show_association`, `static_options`, `dynamic_options`, `sort_options`) VALUES (44, 24, 'no', 'no', 'Draft, Published', NULL, 'no');
INSERT INTO`tbl_fields_select` (`id`, `field_id`, `allow_multiple_selection`, `show_association`, `static_options`, `dynamic_options`, `sort_options`) VALUES (45, 28, 'no', 'no', 'draft, published', NULL, 'no');
INSERT INTO`tbl_fields_select` (`id`, `field_id`, `allow_multiple_selection`, `show_association`, `static_options`, `dynamic_options`, `sort_options`) VALUES (46, 29, 'no', 'no', 'no, yes', NULL, 'no');
INSERT INTO`tbl_fields_select` (`id`, `field_id`, `allow_multiple_selection`, `show_association`, `static_options`, `dynamic_options`, `sort_options`) VALUES (43, 35, 'no', 'no', 'new, approved, rejected', NULL, 'no');
...
INSERT INTO`tbl_fields_subsectionmanager` (`id`, `field_id`, `subsection_id`, `filter_tags`, `caption`, `droptext`, `create`, `remove`, `allow_multiple`, `edit`, `sort`, `drop`, `show_search`, `show_preview`, `recursion_levels`) VALUES (5, 36, 4, NULL, '{$title}', '{$intro}', 1, 1, 1, 1, 1, 1, 1, 1, 0);
INSERT INTO`tbl_fields_subsectionmanager` (`id`, `field_id`, `subsection_id`, `filter_tags`, `caption`, `droptext`, `create`, `remove`, `allow_multiple`, `edit`, `sort`, `drop`, `show_search`, `show_preview`, `recursion_levels`) VALUES (6, 37, 2, NULL, '{$caption}', '{$alt}', 1, 1, 1, 1, 1, 1, 1, 1, 0);
...
INSERT INTO`tbl_fields_textarea` (`id`, `field_id`, `formatter`, `size`) VALUES (73, 2, 'textileplusinline', 2);
INSERT INTO`tbl_fields_textarea` (`id`, `field_id`, `formatter`, `size`) VALUES (72, 8, 'textileplusinline', 2);
INSERT INTO`tbl_fields_textarea` (`id`, `field_id`, `formatter`, `size`) VALUES (67, 12, 'markdown_with_purifier', 5);
INSERT INTO`tbl_fields_textarea` (`id`, `field_id`, `formatter`, `size`) VALUES (68, 18, 'markdown_extra_with_smartypants', 4);
INSERT INTO`tbl_fields_textarea` (`id`, `field_id`, `formatter`, `size`) VALUES (69, 19, 'markdown_extra_with_smartypants', 6);
INSERT INTO`tbl_fields_textarea` (`id`, `field_id`, `formatter`, `size`) VALUES (70, 20, 'markdown_extra_with_smartypants', 12);
INSERT INTO`tbl_fields_textarea` (`id`, `field_id`, `formatter`, `size`) VALUES (71, 27, 'markdown_extra_with_smartypants', 20);
INSERT INTO`tbl_fields_textarea` (`id`, `field_id`, `formatter`, `size`) VALUES (74, 3, 'markdown_extra_with_smartypants', 15);
...
INSERT INTO`tbl_fields_upload` (`id`, `field_id`, `destination`, `validator`) VALUES (8, 6, '/workspace/img/attached', '/\\.(?:bmp|gif|jpe?g|png)$/i');
INSERT INTO`tbl_fields_upload` (`id`, `field_id`, `destination`, `validator`) VALUES (7, 25, '/workspace/img/attached', '/\\.(?:bmp|gif|jpe?g|png)$/i');
...
INSERT INTO`tbl_entries_data_1` (`id`, `entry_id`, `handle`, `value`) VALUES (55, 25, 'a-little-update', 'A Little Update');
INSERT INTO`tbl_entries_data_1` (`id`, `entry_id`, `handle`, `value`) VALUES (25, 26, 'chili-cookoff', 'Chili Cookoff!');
INSERT INTO`tbl_entries_data_1` (`id`, `entry_id`, `handle`, `value`) VALUES (54, 35, 'the-fall-cooking-season-is-starting', 'The Fall Cooking Season is Starting!');
INSERT INTO`tbl_entries_data_1` (`id`, `entry_id`, `handle`, `value`) VALUES (53, 37, 'in-the-spirit-of-oktoberfest', 'In The Spirit of Oktoberfest...');
INSERT INTO`tbl_entries_data_1` (`id`, `entry_id`, `handle`, `value`) VALUES (52, 43, 'project-pizza', 'Project: PIZZA!');
INSERT INTO`tbl_entries_data_1` (`id`, `entry_id`, `handle`, `value`) VALUES (51, 58, 'pp-chucks-restaurant', 'PP: Chuck\'s Restaurant');
...
INSERT INTO`tbl_entries_data_16` (`id`, `entry_id`, `value`) VALUES (44, 25, 'no');
INSERT INTO`tbl_entries_data_16` (`id`, `entry_id`, `value`) VALUES (43, 35, 'no');
INSERT INTO`tbl_entries_data_16` (`id`, `entry_id`, `value`) VALUES (42, 37, 'no');
INSERT INTO`tbl_entries_data_16` (`id`, `entry_id`, `value`) VALUES (41, 43, 'no');
INSERT INTO`tbl_entries_data_16` (`id`, `entry_id`, `value`) VALUES (40, 58, 'no');
...
INSERT INTO`tbl_entries_data_2` (`id`, `entry_id`, `value`, `value_formatted`) VALUES (55, 25, 'Just a little update on m\'site!', 'Just a little update on m<span class=\"rsquo squo\">&#8217;</span>site!');
...
INSERT INTO`tbl_entries_data_2` (`id`, `entry_id`, `value`, `value_formatted`) VALUES (54, 35, 'It\'s cooking season and I have some stuff to share with you. Check out my new recipes.', 'It<span class=\"rsquo squo\">&#8217;</span>s cooking season and I have some stuff to share with you. Check out my new recipes.');
INSERT INTO`tbl_entries_data_2` (`id`, `entry_id`, `value`, `value_formatted`) VALUES (53, 37, 'This weekend my coworkers and I had a little dip contest. Being that it is October, I decided that beer cheese would be appropriate. Here\'s my recipe.', 'This weekend my coworkers and I had a little dip contest. Being that it is October, I decided that beer cheese would be appropriate. Here<span class=\"rsquo squo\">&#8217;</span>s my recipe.');
INSERT INTO`tbl_entries_data_2` (`id`, `entry_id`, `value`, `value_formatted`) VALUES (52, 43, 'Last summer a friend of mine, who recently moved to town, asked me where to get pizza in town. I didn\'t know what to tell him.', 'Last summer a friend of mine, who recently moved to town, asked me where to get pizza in town. I didn<span class=\"rsquo squo\">&#8217;</span>t know what to tell him.');
INSERT INTO`tbl_entries_data_2` (`id`, `entry_id`, `value`, `value_formatted`) VALUES (51, 58, 'Project: PIZZA! For the first official project pizza visit and review we went to Chuck\'s Restaurant in Highland Park.', 'Project: PIZZA! For the first official project pizza visit and review we went to Chuck<span class=\"rsquo squo\">&#8217;</span>s Restaurant in Highland Park.');
...
INSERT INTO`tbl_entries_data_25` (`id`, `entry_id`, `file`, `size`, `mimetype`, `meta`) VALUES (4, 17, '3_5896956882702925134001362330449465891637n.jpg', 156567, 'image/jpeg', 'a:3:{s:8:\"creation\";s:25:\"2011-05-13T12:54:12-05:00\";s:5:\"width\";i:720;s:6:\"height\";i:540;}');
INSERT INTO`tbl_entries_data_25` (`id`, `entry_id`, `file`, `size`, `mimetype`, `meta`) VALUES (8, 20, NULL, NULL, NULL, NULL);
INSERT INTO`tbl_entries_data_25` (`id`, `entry_id`, `file`, `size`, `mimetype`, `meta`) VALUES (11, 21, '7_iowa-interactive-006.jpg', 48745, 'image/jpeg', 'a:3:{s:8:\"creation\";s:25:\"2011-10-03T12:02:26-05:00\";s:5:\"width\";i:600;s:6:\"height\";i:450;}');
...
INSERT INTO`tbl_entries_data_25` (`id`, `entry_id`, `file`, `size`, `mimetype`, `meta`) VALUES (19, 33, 'gnocchi-soup.jpg', 232127, 'image/jpeg', 'a:3:{s:8:\"creation\";s:25:\"2011-10-04T15:32:19-05:00\";s:5:\"width\";i:800;s:6:\"height\";i:600;}');
INSERT INTO`tbl_entries_data_25` (`id`, `entry_id`, `file`, `size`, `mimetype`, `meta`) VALUES (28, 36, 'beer-cheese-dip-2.jpg', 476244, 'image/jpeg', 'a:3:{s:8:\"creation\";s:25:\"2011-10-24T17:01:22-05:00\";s:5:\"width\";i:938;s:6:\"height\";i:687;}');
INSERT INTO`tbl_entries_data_25` (`id`, `entry_id`, `file`, `size`, `mimetype`, `meta`) VALUES (37, 65, 'curry-chicken-salad.jpeg', 144049, 'image/jpeg', 'a:3:{s:8:\"creation\";s:25:\"2012-06-07T11:19:23-05:00\";s:5:\"width\";i:612;s:6:\"height\";i:612;}');
...
INSERT INTO`tbl_entries_data_36` (`id`, `entry_id`, `relation_id`) VALUES (1, 58, NULL);
INSERT INTO`tbl_entries_data_36` (`id`, `entry_id`, `relation_id`) VALUES (2, 43, NULL);
INSERT INTO`tbl_entries_data_36` (`id`, `entry_id`, `relation_id`) VALUES (3, 37, 36);
INSERT INTO`tbl_entries_data_36` (`id`, `entry_id`, `relation_id`) VALUES (4, 35, NULL);
INSERT INTO`tbl_entries_data_36` (`id`, `entry_id`, `relation_id`) VALUES (5, 25, NULL);
...
INSERT INTO`tbl_entries_data_37` (`id`, `entry_id`, `relation_id`) VALUES (1, 58, 59);
INSERT INTO`tbl_entries_data_37` (`id`, `entry_id`, `relation_id`) VALUES (2, 58, 60);
INSERT INTO`tbl_entries_data_37` (`id`, `entry_id`, `relation_id`) VALUES (3, 58, 61);
INSERT INTO`tbl_entries_data_37` (`id`, `entry_id`, `relation_id`) VALUES (4, 58, 62);
INSERT INTO`tbl_entries_data_37` (`id`, `entry_id`, `relation_id`) VALUES (5, 43, 44);
INSERT INTO`tbl_entries_data_37` (`id`, `entry_id`, `relation_id`) VALUES (6, 37, 38);
INSERT INTO`tbl_entries_data_37` (`id`, `entry_id`, `relation_id`) VALUES (7, 35, 34);
INSERT INTO`tbl_entries_data_37` (`id`, `entry_id`, `relation_id`) VALUES (8, 25, 24);
...
INSERT INTO`tbl_entries_data_4` (`id`, `entry_id`, `value`, `date`) VALUES (55, 25, '2011-10-03T00:00:00-05:00', '2011-10-03 05:00:00');
INSERT INTO`tbl_entries_data_4` (`id`, `entry_id`, `value`, `date`) VALUES (25, 26, '2011-10-06T11:00:00-05:00', '2011-10-06 16:00:00');
INSERT INTO`tbl_entries_data_4` (`id`, `entry_id`, `value`, `date`) VALUES (54, 35, '2011-10-04T00:00:00-05:00', '2011-10-04 05:00:00');
INSERT INTO`tbl_entries_data_4` (`id`, `entry_id`, `value`, `date`) VALUES (53, 37, '2011-10-24T00:00:00-05:00', '2011-10-24 05:00:00');
INSERT INTO`tbl_entries_data_4` (`id`, `entry_id`, `value`, `date`) VALUES (52, 43, '2012-03-01T00:00:00-06:00', '2012-03-01 06:00:00');
INSERT INTO`tbl_entries_data_4` (`id`, `entry_id`, `value`, `date`) VALUES (51, 58, '2012-03-02T00:00:00-06:00', '2012-03-02 06:00:00');
...
INSERT INTO`tbl_entries_data_5` (`id`, `entry_id`, `handle`, `value`) VALUES (55, 25, 'published', 'published');
INSERT INTO`tbl_entries_data_5` (`id`, `entry_id`, `handle`, `value`) VALUES (25, 26, 'draft', 'draft');
INSERT INTO`tbl_entries_data_5` (`id`, `entry_id`, `handle`, `value`) VALUES (54, 35, 'published', 'published');
INSERT INTO`tbl_entries_data_5` (`id`, `entry_id`, `handle`, `value`) VALUES (53, 37, 'published', 'published');
INSERT INTO`tbl_entries_data_5` (`id`, `entry_id`, `handle`, `value`) VALUES (52, 43, 'published', 'published');
INSERT INTO`tbl_entries_data_5` (`id`, `entry_id`, `handle`, `value`) VALUES (51, 58, 'published', 'published');
...
INSERT INTO`tbl_entries_data_6` (`id`, `entry_id`, `file`, `size`, `mimetype`, `meta`) VALUES (7, 24, '227315_607116891061_34001362_33413650_8079810_n.jpg', 47702, 'image/jpeg', 'a:3:{s:8:\"creation\";s:25:\"2011-10-03T14:54:18-05:00\";s:5:\"width\";i:720;s:6:\"height\";i:478;}');
INSERT INTO`tbl_entries_data_6` (`id`, `entry_id`, `file`, `size`, `mimetype`, `meta`) VALUES (8, 34, 'fall-color-ledges-st-park.jpg', 204376, 'image/jpeg', 'a:3:{s:8:\"creation\";s:25:\"2011-10-04T15:46:10-05:00\";s:5:\"width\";i:960;s:6:\"height\";i:720;}');
INSERT INTO`tbl_entries_data_6` (`id`, `entry_id`, `file`, `size`, `mimetype`, `meta`) VALUES (9, 38, 'beer-cheese-dip-1.jpg', 418879, 'image/jpeg', 'a:3:{s:8:\"creation\";s:25:\"2011-10-24T17:29:07-05:00\";s:5:\"width\";i:1000;s:6:\"height\";i:726;}');
INSERT INTO`tbl_entries_data_6` (`id`, `entry_id`, `file`, `size`, `mimetype`, `meta`) VALUES (10, 44, 'pizza-pagliais.jpg', 849152, 'image/jpeg', 'a:3:{s:8:\"creation\";s:25:\"2012-03-01T15:33:57-06:00\";s:5:\"width\";i:1632;s:6:\"height\";i:1224;}');
INSERT INTO`tbl_entries_data_6` (`id`, `entry_id`, `file`, `size`, `mimetype`, `meta`) VALUES (11, 59, 'img_0017.jpg', 92022, 'image/jpeg', 'a:3:{s:8:\"creation\";s:25:\"2012-03-02T18:32:59-06:00\";s:5:\"width\";i:800;s:6:\"height\";i:541;}');
INSERT INTO`tbl_entries_data_6` (`id`, `entry_id`, `file`, `size`, `mimetype`, `meta`) VALUES (13, 60, 'img_0021.jpg', 106111, 'image/jpeg', 'a:3:{s:8:\"creation\";s:25:\"2012-03-02T18:33:45-06:00\";s:5:\"width\";i:800;s:6:\"height\";i:600;}');
INSERT INTO`tbl_entries_data_6` (`id`, `entry_id`, `file`, `size`, `mimetype`, `meta`) VALUES (14, 61, 'img_0018.jpg', 115327, 'image/jpeg', 'a:3:{s:8:\"creation\";s:25:\"2012-03-02T18:35:35-06:00\";s:5:\"width\";i:800;s:6:\"height\";i:600;}');
INSERT INTO`tbl_entries_data_6` (`id`, `entry_id`, `file`, `size`, `mimetype`, `meta`) VALUES (15, 62, 'img_0013.jpg', 56672, 'image/jpeg', 'a:3:{s:8:\"creation\";s:25:\"2012-03-02T18:36:32-06:00\";s:5:\"width\";i:800;s:6:\"height\";i:600;}');
...
INSERT INTO`tbl_dashboard_panels` (`id`, `label`, `type`, `config`, `placement`, `sort_order`) VALUES (2, 'Recent Entries', 'datasource_to_table', 'a:1:{s:10:\"datasource\";s:13:\"entry_listing\";}', 'secondary', 2);

-- *** DATA:`tbl_entries` ***
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (38, 2, 1, '2011-10-24 17:29:07', '2011-10-24 22:29:07', '2011-10-24 17:29:07', '2011-10-24 22:29:07');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (26, 1, 1, '2011-10-03 15:00:19', '2011-10-03 20:00:19', '2011-10-03 15:00:19', '2011-10-03 20:00:19');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (25, 1, 1, '2011-10-03 14:54:38', '2011-10-03 19:54:38', '2014-02-07 12:07:31', '2014-02-07 18:07:31');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (24, 2, 1, '2011-10-03 14:54:18', '2011-10-03 19:54:18', '2011-10-03 14:54:18', '2011-10-03 19:54:18');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (37, 1, 1, '2011-10-24 17:27:27', '2011-10-24 22:27:27', '2014-02-07 12:06:40', '2014-02-07 18:06:40');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (32, 4, 1, '2011-10-03 16:52:16', '2011-10-03 21:52:16', '2011-10-03 16:52:16', '2011-10-03 21:52:16');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (36, 4, 1, '2011-10-24 09:53:11', '2011-10-24 14:53:11', '2011-10-24 09:53:11', '2011-10-24 14:53:11');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (35, 1, 1, '2011-10-04 15:46:19', '2011-10-04 20:46:19', '2014-02-07 12:07:21', '2014-02-07 18:07:21');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (34, 2, 1, '2011-10-04 15:46:10', '2011-10-04 20:46:10', '2011-10-04 15:46:10', '2011-10-04 20:46:10');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (33, 4, 1, '2011-10-04 15:32:19', '2011-10-04 20:32:19', '2011-10-04 15:32:19', '2011-10-04 20:32:19');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (17, 4, 1, '2011-05-13 12:54:12', '2011-05-13 17:54:12', '2011-05-13 12:54:12', '2011-05-13 17:54:12');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (18, 5, 1, '2011-09-30 14:02:21', '2011-09-30 19:02:21', '2011-09-30 14:02:21', '2011-09-30 19:02:21');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (20, 4, 1, '2011-10-03 11:56:35', '2011-10-03 16:56:35', '2011-10-03 11:56:35', '2011-10-03 16:56:35');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (21, 4, 1, '2011-10-03 12:02:26', '2011-10-03 17:02:26', '2011-10-03 12:02:26', '2011-10-03 17:02:26');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (22, 4, 1, '2011-10-03 12:12:00', '2011-10-03 17:12:00', '2011-10-03 12:12:00', '2011-10-03 17:12:00');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (23, 5, 1, '2011-10-03 14:02:18', '2011-10-03 19:02:18', '2011-10-03 14:02:18', '2011-10-03 19:02:18');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (43, 1, 1, '2012-03-01 15:32:24', '2012-03-01 21:32:24', '2014-02-07 12:06:00', '2014-02-07 18:06:00');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (44, 2, 1, '2012-03-01 15:33:56', '2012-03-01 21:33:56', '2012-03-01 15:33:56', '2012-03-01 21:33:56');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (55, 3, 1, '2012-03-02 09:11:29', '2012-03-02 15:11:29', '2012-03-02 09:11:29', '2012-03-02 15:11:29');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (52, 3, 1, '2012-03-01 19:32:36', '2012-03-02 01:32:36', '2012-03-01 19:32:36', '2012-03-02 01:32:36');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (53, 3, 1, '2012-03-01 21:16:51', '2012-03-02 03:16:51', '2012-03-01 21:16:51', '2012-03-02 03:16:51');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (54, 3, 1, '2012-03-02 08:27:52', '2012-03-02 14:27:52', '2012-03-02 08:27:52', '2012-03-02 14:27:52');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (59, 2, 1, '2012-03-02 18:32:59', '2012-03-03 00:32:59', '2012-03-02 18:32:59', '2012-03-03 00:32:59');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (58, 1, 1, '2012-03-02 17:08:00', '2012-03-02 23:08:00', '2014-02-07 12:05:18', '2014-02-07 18:05:18');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (60, 2, 1, '2012-03-02 18:33:45', '2012-03-03 00:33:45', '2012-03-02 18:33:45', '2012-03-03 00:33:45');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (61, 2, 1, '2012-03-02 18:35:35', '2012-03-03 00:35:35', '2012-03-02 18:35:35', '2012-03-03 00:35:35');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (62, 2, 1, '2012-03-02 18:36:32', '2012-03-03 00:36:32', '2012-03-02 18:36:32', '2012-03-03 00:36:32');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (64, 3, 1, '2012-03-28 11:16:07', '2012-03-28 16:16:07', '2012-03-28 11:16:07', '2012-03-28 16:16:07');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (65, 4, 1, '2012-06-07 11:18:07', '2012-06-07 16:18:07', '2012-06-07 11:18:07', '2012-06-07 16:18:07');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (66, 4, 1, '2012-06-07 11:27:20', '2012-06-07 16:27:20', '2012-06-07 11:27:20', '2012-06-07 16:27:20');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (67, 3, 1, '2012-08-21 04:56:10', '2012-08-21 09:56:10', '2012-08-21 04:56:10', '2012-08-21 09:56:10');
INSERT INTO`tbl_entries` (`id`, `section_id`, `author_id`, `creation_date`, `creation_date_gmt`, `modification_date`, `modification_date_gmt`) VALUES (68, 3, 1, '2012-09-05 00:30:36', '2012-09-05 05:30:36', '2012-09-05 00:30:36', '2012-09-05 05:30:36');

-- *** DATA:`tbl_extensions` ***
INSERT INTO`tbl_extensions` (`id`, `name`, `status`, `version`) VALUES (1, 'xssfilter', 'enabled', 1.2);
INSERT INTO`tbl_extensions` (`id`, `name`, `status`, `version`) VALUES (2, 'debugdevkit', 'enabled', '1.2.4');
INSERT INTO`tbl_extensions` (`id`, `name`, `status`, `version`) VALUES (3, 'textileplusformatter', 'enabled', '1.0.3');
INSERT INTO`tbl_extensions` (`id`, `name`, `status`, `version`) VALUES (15, 'subsectionmanager', 'enabled', '3.5.1');
INSERT INTO`tbl_extensions` (`id`, `name`, `status`, `version`) VALUES (17, 'dashboard', 'enabled', '1.6.0');
INSERT INTO`tbl_extensions` (`id`, `name`, `status`, `version`) VALUES (7, 'jit_image_manipulation', 'enabled', 1.21);
INSERT INTO`tbl_extensions` (`id`, `name`, `status`, `version`) VALUES (8, 'export_ensemble', 'enabled', '2.0.3');
INSERT INTO`tbl_extensions` (`id`, `name`, `status`, `version`) VALUES (9, 'datemodified', 'enabled', 1.3);
INSERT INTO`tbl_extensions` (`id`, `name`, `status`, `version`) VALUES (12, 'maintenance_mode', 'enabled', 1.7);
INSERT INTO`tbl_extensions` (`id`, `name`, `status`, `version`) VALUES (13, 'sitename', 'enabled', 1.1);
INSERT INTO`tbl_extensions` (`id`, `name`, `status`, `version`) VALUES (14, 'email_template_manager', 'enabled', 5.0);
INSERT INTO`tbl_extensions` (`id`, `name`, `status`, `version`) VALUES (16, 'markdown', 'enabled', 1.17);

-- *** DATA:`tbl_extensions_delegates` ***
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (63, 1, '/blueprints/events/edit/', 'AppendEventFilter', 'appendEventFilter');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (66, 2, '/frontend/', 'ManipulateDevKitNavigation', 'manipulateDevKitNavigation');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (65, 2, '/frontend/', 'FrontendDevKitResolve', 'frontendDevKitResolve');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (64, 1, '/frontend/', 'EventPreSaveFilter', 'eventPreSaveFilter');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (82, 15, '/backend/', 'AdminPagePreGenerate', '__appendAssets');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (83, 15, '/blueprints/datasources/', 'DatasourcePostCreate', '__clearSubsectionCache');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (84, 15, '/blueprints/datasources/', 'DatasourcePostEdit', '__clearSubsectionCache');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (99, 17, '/system/authors/', 'AddDefaultAuthorAreas', 'author_default_section');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (98, 17, '/backend/', 'DashboardPanelTypes', 'dashboard_panel_types');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (72, 8, '/system/preferences/', 'AddCustomPreferenceFieldsets', 'appendPreferences');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (79, 12, '/blueprints/pages/', 'AppendPageContent', '__appendType');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (78, 12, '/backend/', 'AppendPageAlert', '__appendAlert');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (77, 12, '/system/preferences/', 'CustomActions', '__toggleMaintenanceMode');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (76, 12, '/system/preferences/', 'Save', '__SavePreferences');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (75, 12, '/system/preferences/', 'AddCustomPreferenceFieldsets', 'appendPreferences');
...
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (73, 7, '/system/preferences/', 'AddCustomPreferenceFieldsets', 'appendPreferences');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (62, 1, '/blueprints/events/new/', 'AppendEventFilter', 'appendEventFilter');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (70, 14, '/blueprints/events/edit/', 'AppendEventFilterDocumentation', 'appendEventFilterDocumentation');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (69, 14, '/frontend/', 'EventFinalSaveFilter', 'eventFinalSaveFilter');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (68, 14, '/blueprints/events/new/', 'AppendEventFilter', 'appendEventFilter');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (67, 14, '/blueprints/events/edit/', 'AppendEventFilter', 'appendEventFilter');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (71, 14, '/blueprints/datasources/', 'DatasourcePostEdit', 'datasourcePostEdit');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (74, 7, '/system/preferences/', 'Save', '__SavePreferences');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (80, 12, '/frontend/', 'FrontendPrePageResolve', '__checkForMaintenanceMode');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (81, 12, '/frontend/', 'FrontendParamsResolve', '__addParam');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (85, 15, '/blueprints/datasources/', 'DatasourcePreDelete', '__clearSubsectionCache');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (86, 15, '/frontend/', 'DataSourceEntriesBuilt', '__prepareSubsection');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (97, 17, '/backend/', 'DashboardPanelOptions', 'dashboard_panel_options');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (96, 17, '/backend/', 'DashboardPanelRender', 'render_panel');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (95, 17, '/backend/', 'AdminPagePreGenerate', 'page_pre_generate');
INSERT INTO`tbl_extensions_delegates` (`id`, `extension_id`, `page`, `delegate`, `callback`) VALUES (94, 17, '/backend/', 'InitaliseAdminPageHead', 'append_assets');
...
INSERT INTO`tbl_fields` (`id`, `label`, `element_name`, `type`, `parent_section`, `required`, `sortorder`, `location`, `show_column`) VALUES (4, 'Publish Date', 'publish-date', 'date', 1, 'no', 5, 'sidebar', 'yes');
INSERT INTO`tbl_fields` (`id`, `label`, `element_name`, `type`, `parent_section`, `required`, `sortorder`, `location`, `show_column`) VALUES (5, 'Status', 'status', 'select', 1, 'yes', 6, 'sidebar', 'yes');
...
INSERT INTO`tbl_fields` (`id`, `label`, `element_name`, `type`, `parent_section`, `required`, `sortorder`, `location`, `show_column`) VALUES (37, 'Attached Images', 'attached-images', 'subsectionmanager', 1, 'no', 4, 'main', 'yes');
...
INSERT INTO`tbl_fields` (`id`, `label`, `element_name`, `type`, `parent_section`, `required`, `sortorder`, `location`, `show_column`) VALUES (16, 'Disable comments on this entry', 'disable-comments', 'checkbox', 1, 'no', 7, 'sidebar', 'yes');
...
INSERT INTO`tbl_fields` (`id`, `label`, `element_name`, `type`, `parent_section`, `required`, `sortorder`, `location`, `show_column`) VALUES (36, 'Recipe', 'recipe', 'subsectionmanager', 1, 'no', 3, 'main', 'yes');
...
-- *** DATA:`tbl_sections` ***
INSERT INTO`tbl_sections` (`id`, `name`, `handle`, `sortorder`, `hidden`, `navigation_group`) VALUES (1, 'Weblog Entries', 'weblog-entries', 1, 'no', 'Content');
INSERT INTO`tbl_sections` (`id`, `name`, `handle`, `sortorder`, `hidden`, `navigation_group`) VALUES (2, 'Images', 'images', 2, 'no', 'Content');
INSERT INTO`tbl_sections` (`id`, `name`, `handle`, `sortorder`, `hidden`, `navigation_group`) VALUES (3, 'Comments', 'comments', 3, 'no', 'Feedback');
INSERT INTO`tbl_sections` (`id`, `name`, `handle`, `sortorder`, `hidden`, `navigation_group`) VALUES (4, 'Recipes', 'recipes', 4, 'no', 'Content');
INSERT INTO`tbl_sections` (`id`, `name`, `handle`, `sortorder`, `hidden`, `navigation_group`) VALUES (5, 'Pages', 'pages', 5, 'no', 'Content');

-- *** DATA:`tbl_sections_association` ***
INSERT INTO`tbl_sections_association` (`id`, `parent_section_id`, `parent_section_field_id`, `child_section_id`, `child_section_field_id`, `hide_association`) VALUES (20, 1, 1, 3, 13, 'yes');
INSERT INTO`tbl_sections_association` (`id`, `parent_section_id`, `parent_section_field_id`, `child_section_id`, `child_section_field_id`, `hide_association`) VALUES (22, 1, 37, 2, 37, 'yes');
INSERT INTO`tbl_sections_association` (`id`, `parent_section_id`, `parent_section_field_id`, `child_section_id`, `child_section_field_id`, `hide_association`) VALUES (21, 1, 36, 4, 36, 'yes');
